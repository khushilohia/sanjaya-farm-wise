      ...
      <AppLayout>
        ...
        <section className="container mx-auto px-4 pb-20">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <IconCard icon={Users} title="Farmer management" description="View active profiles and onboarding status." tone="primary" />
            <IconCard icon={TrendingUp} title="Production forecast" description="Predict crop output with AI trends." tone="harvest" />
            <IconCard icon={Bug} title="Disease monitoring" description="Track outbreaks and respond quickly." tone="destructive" />
            <IconCard icon={Activity} title="AI analytics" description="Monitor voice usage and query patterns." tone="sky" />
          </div>
        </section>
      </AppLayout>
    </AuthGuard>
