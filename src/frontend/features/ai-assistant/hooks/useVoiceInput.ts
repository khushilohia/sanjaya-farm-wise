...
import { transcribeAudio } from "@/backend/api/serverFns";
...
export type SpeechError = "permission-denied" | "no-speech" | "network" | "unknown";
 ...
 */
export function useVoiceInput(lang: string, onFinalTranscript: (text: string) => void) {
