...
const FORUM_POSTS = [
  {
    ...
    preview:
      "I have noticed the capsules are starting to turn slightly red. Should I wait another week or harvest now?",
    timeAgo: "3 hours ago",
    replies: 14,
    color: "bg-primary",
  },
  {
    ...
    preview:
      "Found soft brown spots on my ginger rhizomes after the heavy rain. Using neem cake right now but looking for more effective options.",
    timeAgo: "1 day ago",
    replies: 8,
    color: "bg-harvest",
  },
  {
    ...
    preview:
      "My neighbour got the installment last week but I haven't received mine yet. Who should I contact at the block office?",
    timeAgo: "2 days ago",
    replies: 21,
    color: "bg-sky",
  },
...
const VIDEOS = [
  ...
  {
    title: "Irrigation planning for hills",
    duration: "15 min",
    views: "2.8k",
    topic: "Irrigation",
  },
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {VIDEOS.map((video) => (
              <Card
                key={video.title}
                className="border-border/60 bg-card overflow-hidden group cursor-pointer"
              >
