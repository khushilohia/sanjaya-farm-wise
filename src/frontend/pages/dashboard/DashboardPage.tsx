  ...
  const steps = [
    {
      n: 1,
      title: "Crop stages",
      done: cropEntries.length > 0 && cropEntries.every((c) => c.stage),
    },
        ...
        <div className="mt-5 space-y-5">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setDraftCrops((d) =>
                            d.map((c, idx) =>
                              idx === i ? { ...c, plantedDate: e.target.value } : c,
                            ),
                          )
                        }
                        className="text-sm"
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setDraftCrops((d) =>
                            d.map((c, idx) =>
                              idx === i ? { ...c, areaAcres: e.target.value } : c,
                            ),
                          )
                        }
                        className="text-sm"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setDraftCrops((d) =>
                          d.map((c, idx) =>
                            idx === i ? { ...c, progress: Number(e.target.value) } : c,
                          ),
                        )
                      }
          ...
          {allDone && (
            <div className="flex items-center gap-2 text-sm text-primary font-medium">
              <CheckCircle2 className="h-4 w-4" /> Farm setup complete! Your dashboard is now
              personalized.
            </div>
          )}
        </div>
...
export function DashboardPage() {
  const user = useAuthStore((s) => s.user);
  const { cropEntries, soilType, irrigationSource, nearestMandi, setupComplete, aiLogs } =
    useFarmStore();
            ...
            <div className="space-y-6 lg:col-span-2">
              ...
              <Card className="border-border/60 p-6">
                ...
                <Button asChild variant="outline" size="sm" className="mt-4">
                  <Link to="/weather">
                    Full forecast <ArrowRight className="h-3.5 w-3.5 ml-1" />
                  </Link>
                </Button>
              </Card>
              ...
              <Card className="border-border/60 bg-linear-to-br from-primary/5 to-card p-6">
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-3">
                  ...
                  <Advice
                    ...
                    title="Pest watch"
                    body={pestAdvice}
                    tone={humidity !== null && humidity > 80 ? "destructive" : "sky"}
                  />
                </div>
                <Button asChild variant="link" className="mt-2 gap-1 px-0 text-primary">
                  <Link to="/assistant">
                    Ask AI for details <ArrowRight className="h-3.5 w-3.5" />
                  </Link>
                </Button>
              </Card>
              ...
              {cropEntries.length > 0 ? (
                <Card className="border-border/60 p-6">
                  <div className="flex items-center justify-between">
                    ...
                    {setupComplete && (
                      <Badge variant="secondary">{irrigationSource || "Farm"}</Badge>
                    )}
                  </div>
                ...
                <Card className="border-dashed border-2 border-border/40 p-8 text-center">
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    Complete the farm setup above to see your crop tracker here.
                  </p>
                </Card>
              )}
            </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-border/60 p-6">
                ...
                <Button asChild variant="outline" className="mt-4 w-full">
                  <Link to="/market">
                    Open marketplace <ArrowRight className="h-3.5 w-3.5 ml-1" />
                  </Link>
                </Button>
              </Card>
              ...
              {aiLogs.length > 0 && (
                <Card className="border-border/60 p-6">
                  ...
                  <Button asChild variant="link" className="mt-2 px-0 text-primary text-xs gap-1">
                    <Link to="/assistant">
                      Open AI assistant <ArrowRight className="h-3 w-3" />
                    </Link>
                  </Button>
                </Card>
              )}
