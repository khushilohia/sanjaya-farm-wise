...
const CROP_OPTIONS = ["Cardamom", "Ginger", "Rice", "Maize", "Vegetables", "Tea", "Wheat"];
            ...
            <form onSubmit={form1.handleSubmit(handleStep1)} className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  <Input id="name" placeholder="Pemba Sherpa" {...form1.register("name")} />
            ...
            <form onSubmit={form2.handleSubmit(handleStep2)} className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  <Input id="village" placeholder="Gangtok" {...form2.register("village")} />
                ...
                <div className="space-y-1.5">
                  ...
                  <Select onValueChange={(v) => form2.setValue("soilType", v)}>
                    <SelectTrigger>
                ...
                <div className="space-y-1.5">
                  ...
                  <Select onValueChange={(v) => form2.setValue("irrigation", v)}>
                    <SelectTrigger>
