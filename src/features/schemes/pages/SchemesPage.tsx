          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <Card className="border-border/60 bg-gradient-to-br from-card to-secondary/40 p-6">
              ...
              <div className="mt-4 space-y-3 text-sm text-muted-foreground">
                <div className="rounded-lg bg-background/60 p-3">Land holding verified — Eligible for PM-Kisan</div>
                <div className="rounded-lg bg-background/60 p-3">Soil test pending — Apply for Soil Health Card</div>
                <div className="rounded-lg bg-background/60 p-3">Insurance renewal due in 12 days</div>
              </div>
            </Card>
          </div>
        </section>
        ...
        <section className="bg-muted/40 py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <IconCard icon={Landmark} title="Scheme match" description="Auto-recommend programs based on your profile." tone="harvest" />
              <IconCard icon={ShieldCheck} title="Eligibility check" description="Clear yes/no based on your location and land size." tone="primary" />
              <IconCard icon={FileText} title="Document checklist" description="Get the exact list of required documents." tone="soil" />
              <IconCard icon={CalendarCheck} title="Application tracking" description="Follow status and receive reminders before deadlines." tone="sky" />
            </div>
          </div>
        </section>
