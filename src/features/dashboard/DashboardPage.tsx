...
export function DashboardPage() {
  return (
    <PageShell className="bg-muted/30" showFooter={false}>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" size="sm" className="gap-2">
              <Bell className="h-4 w-4" /> 3 alerts
            </Button>
          ...
          <div className="space-y-6">
            <Card className="border-border/60 p-6">
              ...
              <div className="mt-4 space-y-3">
                <Price crop="Large cardamom" price="Rs 2,150/kg" change="+4.2%" up />
                <Price crop="Ginger (fresh)" price="Rs 68/kg" change="+1.1%" up />
                <Price crop="Rice (basmati)" price="Rs 42/kg" change="-0.8%" />
              </div>
            ...
            <Card className="border-border/60 bg-linear-to-br from-harvest/15 to-card p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm">
                <li className="flex justify-between"><span>PM-Kisan</span><span className="font-semibold text-primary">Rs 2,000 due</span></li>
